...
from architectures.architecture_cyclegan import ResNet_G_256x256, UNet_G
from architectures.architecture_cyclegan import PatchGan_D_70x70_One_Input, PatchGan_D_286x286_One_Input
from trainers.trainer_lsgan_cyclegan import Trainer_LSGAN_Cyclegan
